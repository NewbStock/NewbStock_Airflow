...
def financial_statements_etl():
    ...
    def fetch_data():
        ...
        url = f"https://ecos.bok.or.kr/api/StatisticSearch/GZJ2WT8Y559OMJKLPMRQ/json/kr/1/99999/501Y001/A/2014/{end_date}"
    ...
    def upload_to_s3(file_path: str):
        ...
        s3_key = 'newb_data/bank_of_korea/raw_data/FinancialStatements.csv'
